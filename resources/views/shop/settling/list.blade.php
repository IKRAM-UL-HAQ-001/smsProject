        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('export.masterSettlingListWeekly') }}" class="btn btn-primary">Download Weekly Master Settling List</a>
                    <a href="{{ route('export.masterSettlingListMonthly') }}" class="btn btn-primary">Download Monthly Master Settling List</a>
                </div>
                <div class="card-body">
